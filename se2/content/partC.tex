...
\author{Thomas Thüm}
\lecture{AI for SE \& SE for AI}{automotive}
...
% \faq{
% 	\item What are examples of insufficient quality of automotive software?
% 	\item What are potential consequences of insufficient quality?
% 	\item Why is automotive software getting more complex over the years?
% 	\item How fast is automotive software growing in size?
% 	\item What are domain, subsystem, function, component referring to in E/E architectures?
% }{
% 	\item What does Conway's law mean for automotive software architecture?
% 	\item What is the difference between federated and centralized software architectures?
% 	\item Why are centralized software architectures are getting more popular?
% 	\item What happens if the central computing node crashes?
% 	\item What is AUTOSAR (used for)?
% 	\item What are automotive examples for layered architecture, pipe-and-filter, publish-subscriber architecture?
% }{
% 	\item What are advanced concepts in software engineering?
% 	\item How to \emph{change} software?
% 	\item How to \emph{verify} software?
% 	\item How to \emph{reuse} software?
% }
