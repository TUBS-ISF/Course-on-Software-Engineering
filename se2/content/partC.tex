...
\faq{
	...
	\item What is free software and how does it differs to freeware?
	\item What is the FSF?
}{
	...
	\item What can erroneous software licenses cause?
}{
	...
	\item What is dual-licensing and why is it used?
}
...
\faq{
	\item How is software typically developed and what are common software development processes?
	...
	\item How does one enumerate all valid configurations of a software product line?
}{
	\item What are the advantages of feature modeling in software development? 
	\item How can we configure runtime-variable software?
	\item How can we implement software variability?
	\item How can we achieve static variability?
	\item What kind of preprocessors are there and how do they differ?
	\item What are advantages and disadvantages of preprocessors?
	\item How can we help developers during product line development?
	\item What are alternative approaches to dynamic variability?
}{
	\item How can we test variable software?
	\item What are the advantages and disadvantages of testing all software configurations?
	\item What are the advantages and disadvantages of testing only one software configuration?
	\item What is pairwise interaction testing?
	\item What are the advantages and disadvantages of pairwise interaction testing?
	\item How do we compute pairwise interaction coverage?
	...
	\item Which feature should we add to our software?
	\item Why should we also remove features from our software?
}
