...
\faq{
	\item What can we learn from the Ariane 5 software failure?
	\item What are common error types and which can be found by compilers?
	\item How can further prevent runtime errors?
	\item What are the advantages and disadvantages of code documentation?
	\item What are the advantages and disadvantages of defensive programming?
	\item What are the advantages and disadvantages of runtime assertions?
	\item What are the advantages and disadvantages of unit testing?
	\item How can we compare all discussed assumption documentation techniques?
}{
	\item Why do we need another assumption documentation technique?
	\item What is Design by Contract?
	\item What are Behavioral Interface Specification Languages?
	\item Why do we use Behavioral Interface Speciﬁcation Languages?
	\item What are common examples Behavioral Interface Speciﬁcation Languages?
	\item How does one use the Java Modeling Language?
	\item What can the Java Modeling Language be used for?
	\item How does the JML compare to other assumption documentation techniques?
}{
	\item What is the Ada programming language and what is it used for?
	\item What is Spark and why are parts of Ada removed?
	\item Which tools does Spark offer for development and verification?
	\item How is Design by Contract implemented in Spark?
	\item How can we formulate code contract in Ada/Spark?
}
