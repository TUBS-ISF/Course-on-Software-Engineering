...
\lessonslearned{
	...
	\item Next: Version control systems in detail
}{
...
\lessonslearned{
	...
	\item Next: Software Product Lines
}{
	\item \sommerville\mychapter{25} 
}{
		Quiz in \StudIP
	...
	\centering\fancyqr{color=black,height=30mm}{https://studip.tu-braunschweig.de/}
}
