...
\subsubsection{Origins [TODO: details für tonspur]}
\larger\def\Mixin{}%
\tikzset{%
...
\begin{tikzpicture}[every node/.append style={execute at begin node={\vphantom{123456789}},circle,draw}]
   \node[rectangle,inner sep=2pt] (1) at (0,0) {\texttt{x}\textsubscript{1}};
   \node[below=3.5mm] (2) at (1.south) {\texttt{x}\textsubscript{2}};
   \node[below=3.5mm,rectangle,inner sep=2pt] (3) at (2.south) {\texttt{x}\textsubscript{3}};
...
\onslide<5->{\node[below] at(@ast.south) {\bfseries Sytactical};}
