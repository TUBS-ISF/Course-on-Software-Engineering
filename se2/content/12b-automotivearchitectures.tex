...
%	\begin{fancycolumns}[widths={60}]
	%		\asesurveylink{\includegraphics[width=\linewidth,page=12,trim=35 410 35 60,clip]{HBP+-JSS17}}
	%	\nextcolumn
	%		\asesurveylink{\includegraphics[width=\linewidth,page=12,trim=320 165 35 420,clip]{HBP+-JSS17}}
	%	\end{fancycolumns}
%\end{frame}
