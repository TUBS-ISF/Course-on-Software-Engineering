...
\begin{frame}[fragile]
	...
	\begin{fancycolumns}
		...
		\end{definition}
		\begin{note}{Considerations for Developing Software}
			\textbf{principles to conisder}: KISS (what is easier to understand), DRY (multiple affected branches) \\\textbf{compiler optimization}: code motion
		\end{note}
		\nextcolumn
		\begin{example}{Example Loop}
			\begin{lstlisting}[language=Java,basicstyle=\scriptsize]
...
\begin{frame}[b]{Memory Management}
	\vspace{-10mm}
