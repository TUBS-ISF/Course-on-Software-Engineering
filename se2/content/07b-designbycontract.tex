...
\begin{frame}[fragile]
	...
	\begin{fancycolumns}
		\begin{motivation}{Goal}
			Precise specification of intended behavior by specifying assumptions and guarantees
		\end{motivation}
		\begin{motivation}{Metaphor}
			\begin{itemize}
				\item Contract between class and its clients
				\item Client must deliver preconditions to receive promised behavior
