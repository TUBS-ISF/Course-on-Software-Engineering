...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{tikzpicture}[node distance=0.5cm, auto]
			...
			\draw[pomcontent] (remoterepo.west) -- (pomxml.east);
...
\begin{frame}
	\frametitle{\insertsubsection{} -- Extension Proposals in Erlang \mytitlesource{https://github.com/erlang/eep}}
		\begin{fancycolumns}[widths={50,50}]
			\begin{figure}
				\centering
				\includegraphics[width=0.8\columnwidth]{configmanagement/eep1.png}
			\end{figure}
			\nextcolumn
			\begin{figure}
				\centering
				\includegraphics[width=0.8\columnwidth]{configmanagement/eep2.png}
			\end{figure}
		\end{fancycolumns}
