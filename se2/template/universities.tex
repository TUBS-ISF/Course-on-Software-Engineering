	...
	\begin{fancycolumns}[t,columns=3,animation=none]
		\mydefinition{\emphifequal{#1}{I}{Part A: \emph{Adapting} Software}}{
			\begin{enumerate}
				...
				\item {\emphifequal{#1}{5}{Architecture}}
			\end{enumerate}
		}
		\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part B: \emph{Verifying} Software}}{
			\begin{enumerate}
				\setcounter{enumi}{4}
				\item {\emphifequal{#1}{6}{Compilation}}
		...
		\mydefinition{\emphifequal{#1}{III}{Part C: \emph{Modern} SE}}{
			\begin{enumerate}
				...
				\item {\emphifequal{#1}{11}{AI for SE \& SE for AI}}
				\item {\emphifequal{#1}{12}{Software Product Lines}}
