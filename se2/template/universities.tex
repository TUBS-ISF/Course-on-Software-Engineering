...
\renewcommand{\author}[1]{
	\ifuniversity{tubs}{\author@old{Chico Sundermann, Raphael Dunkel}}
...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\begin{fancycolumns}[t,columns=3,animation=none]
		\mydefinition{\emphifequal{#1}{I}{Part A: \emph{Adapting} Software}}{
			\begin{enumerate}
				\item {\emphifequal{#1}{1}{Introduction}}
				\item {\emphifequal{#1}{2}{Evolution \& Maintenance}}
				\item {\emphifequal{#1}{3}{Design Patterns}}
				\item {\emphifequal{#1}{4}{Architecture}}
			\end{enumerate}
		}
		\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part B: \emph{Verifying} Software}}{
			\begin{enumerate}
				...
				\item {\emphifequal{#1}{6}{Dynamic Analysis}}
				\item {\emphifequal{#1}{7}{Design by Contract}}
				\item {\emphifequal{#1}{8}{Configuration Management}}
			\end{enumerate}
		}
		\nextcolumn
		\mydefinition{\emphifequal{#1}{III}{Part C: \emph{Modern} SE}}{
			\begin{enumerate}
				\setcounter{enumi}{8}
				\item {\emphifequal{#1}{9}{Open-Source Software}}
				\item {\emphifequal{#1}{10}{AI for SE \& SE for AI}}
				\item {\emphifequal{#1}{11}{Software Product Lines}}
				\item {\emphifequal{#1}{12}{Guest Lectures}}
			\end{enumerate}
		}
	\end{fancycolumns}
}
\newcommand{\skipPartA}{\addtocounter{lecture}{4}}
\newcommand{\skipPartB}{\addtocounter{lecture}{4}}
