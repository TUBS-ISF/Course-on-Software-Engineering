...
\newcommand{\lectureseriesoverview}[1][]{ % shown at the start and end of each lecture
	...
	\begin{fancycolumns}[t,columns=3,animation=none]
		\mydefinition{\emphifequal{#1}{I}{Part I: Development of \emph{Correct} Software}}{
			\begin{enumerate}
	...
	\nextcolumn
		\mydefinition{\emphifequal{#1}{II}{Part II: Development in \emph{Schedule} \& \emph{Budget}}}{
			\begin{enumerate}
				\setcounter{enumi}{5}
	...
	\nextcolumn
		\mydefinition{\emphifequal{#1}{III}{Part III: Development of \emph{Needed} Software}}{
			\begin{enumerate}
				\setcounter{enumi}{7}
