...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{Schichtenarchitektur}}
	...
	\begin{fancycolumns}[animation=none]
		...
		\end{definition}
		\nextcolumn
		\posthandout{\pic[page=24,width=\linewidth,trim=225 20 25 40,clip]{se04-architecture-print}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{2-Schichten-Architektur}}
	\begin{fancycolumns}[animation=none]
		...
		\end{example}
		\nextcolumn
		\posthandout{\pic[page=25,width=\linewidth,trim=225 20 25 40,clip]{se04-architecture-print}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{3-Schichten-Architektur}}
	\begin{fancycolumns}[animation=none]
		...
		\end{example}
		\nextcolumn
		\posthandout{\pic[page=26,width=\linewidth,trim=225 20 25 40,clip]{se04-architecture-print}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		...
		\nextcolumn
		\uncover<3->{\posthandout{\pic[page=29,width=\linewidth,trim=225 20 20 40,clip]{se04-architecture-print}}}
	\end{fancycolumns}
\end{frame}
