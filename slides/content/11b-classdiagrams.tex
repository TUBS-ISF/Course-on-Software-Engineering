...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{Klassendiagramme}}
	\begin{fancycolumns}[animation=none]
		...
		\nextcolumn
		\posthandout{\pic[page=13,width=\linewidth,trim=225 20 20 40,clip]{printedslides/2021wt/design}}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[widths={51},animation=none]
		...
		\nextcolumn
		\posthandout{\pic[page=14,width=\linewidth,trim=225 20 20 40,clip]{printedslides/2021wt/design}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		...
		\nextcolumn
		\posthandout{\pic[page=16,width=\linewidth,trim=225 20 20 40,clip]{printedslides/2021wt/design}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		...
		\nextcolumn
		\posthandout{\pic[page=18,width=\linewidth,trim=225 20 20 40,clip]{printedslides/2021wt/design}}
	\end{fancycolumns}
\end{frame}
