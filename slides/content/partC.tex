...
\input{content/09b-activitydiagrams}
\lessonslearned{
...
\input{content/09c-statemachines}
\lessonslearned{
...
\input{content/10a-architecture}
\lessonslearned{
...
\input{content/10b-componentdiagrams}
\lessonslearned{
...
\input{content/10c-architecturalpatterns}
\lessonslearned{
...
\input{content/11a-sequencediagrams}
\lessonslearned{
...
\input{content/11b-classdiagrams}
\lessonslearned{
...
\input{content/11c-designpatterns}
\lessonslearned{
...
\lessonslearned{
	...
	\begin{enumerate}
		\item Form groups of 2--3 students
		\item Find three example for software systems were you would recommend one of the following licenses: MIT, GPL, LGPL
...
%\lessonslearned{
	...
	%}{
	%	%	\item See \href{https://moodle.uni-ulm.de/mod/moodleoverflow/discussion.php?d=3913}{Moodle} % TODO in 2023 update link
	%	%	\item Answer the quiz in Moodle to track your learning progress
	%	\item[] Post questions in Moodle if you have any
	%	\\\hfill\fancyqr{https://moodle.uni-ulm.de/course/view.php?id=42562\#section-8}
	%}
