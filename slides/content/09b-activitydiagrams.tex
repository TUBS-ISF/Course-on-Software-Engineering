...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		\posthandout{\pic[page=18,width=\linewidth,trim=15 20 225 40,clip]{se03-modeling-print}}
		\nextcolumn
...
\posthandout{
	\begin{frame}{Example of Sequential Activities}
		\pic[page=19,width=\linewidth,trim=0 20 0 40,clip]{se03-modeling-print}
	\end{frame}
}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		\posthandout{\pic[page=20,width=\linewidth,trim=25 20 225 40,clip]{se03-modeling-print}}
		\nextcolumn
...
\posthandout{
	\begin{frame}{Example of Conditional Activities}
		\pic[page=21,width=\linewidth,trim=0 20 0 40,clip]{se03-modeling-print}
	\end{frame}
}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		\posthandout{\pic[page=22,width=\linewidth,trim=25 20 225 40,clip]{se03-modeling-print}}
		\nextcolumn
...
\posthandout{
	\begin{frame}{Example of Concurrent Activities}
		\pic[page=23,width=\linewidth,trim=0 20 0 40,clip]{se03-modeling-print}
	\end{frame}
}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		\posthandout{\pic[page=24,width=\linewidth,trim=20 20 225 40,clip]{se03-modeling-print}}
		\nextcolumn
