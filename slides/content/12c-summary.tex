...
\subsubsection{Lecture 1+12: Software and Reuse}
\begin{frame}{Lecture 1: Software (Engineering) vs Program(ming)}
	\slideSEvsProgramming
\end{frame}
\begin{frame}{Lecture 12: How to avoid software development?}
...
\subsubsection{Lecture 6+7: Management}
\begin{frame}[2]{Lecture 6: How to manage software development?}
	\slideGanttAndNetwork
\end{frame}
\begin{frame}[10]{Lecture 7: How to structure software development?}
