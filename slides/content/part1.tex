...
\ifuniversity{tubs}{\date{November 4, 2024}}
...
\ifuniversity{tubs}{\date{November 11, 2024}}
...
\input{content/05a-versioncontrol}
\lessonslearned{
	...
	\begin{enumerate}
		\item<+-> Form groups of 2-3 students
%		\item Choose a project on Github (see link to famous projects in \panda) % TODO 2024st link to best rated repos (for Java projects)?
%		%\item What is name and purpose of the software?
%		\item What is the main programming language?
%		\item What is the number of commits?
%		\item What is the number of branches?
%		\item Share your insights in \pingo{03}
	\end{enumerate}
}

\section{Operations of Version Control}
\input{content/05b-operations}
\lessonslearned{
