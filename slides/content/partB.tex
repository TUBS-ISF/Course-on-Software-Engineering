...
\lessonslearned{
	...
	%	\item See \href{https://moodle.uni-ulm.de/mod/moodleoverflow/discussion.php?d=3883}{Moodle} % TODO in 2023 update link
	\item 1 minute of silence: Choose one of the four testing stages and think of an example of a fault that can be detected in that testing stage.
	...
	%\item Upload example and explanation to Moodle
