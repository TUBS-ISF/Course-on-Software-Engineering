...
\ifuniversity{tubs}{\date{October 21, 2025}}
...
\lessonslearned{
	...
	\item What are characteristics and categories of software?
...
\ifuniversity{tubs}{\date{October 28, 2025}}
...
\lessonslearned{
	...
	\item Next: What is the most-used tool for programming?
}{
	\item[] \javastyleguide
...
\input{content/02c-versioncontrol}
\lessonslearned{
	...
	\item Semantic Versioning: \href{https://semver.org/}{semver.org}
}{
	\centering
	You need git to submit your exercise solutions.
...
\ifuniversity{tubs}{\date{November 4, 2025}}
...
\input{content/03a-qualityassurance}
\lessonslearned{
...
\input{content/03b-whiteboxtesting}
\lessonslearned{
	...
	\begin{enumerate}
		\item Determine the coverage of this test suite:
%			\begin{enumerate} % 2024wt
%				\item a = 5, b = -5, m = 0
%				\item a = 5, b = 5, m = 0
%				\item a = 10, b = 5, m = 0
%			\end{enumerate}
			\begin{itemize} % 2025wt, no coverage
				\item TC1: a = 3, b = -5, m = 3
				\item TC2: a = 3, b = 5, m = 3
			\end{itemize}
...
\input{content/03c-blackboxtesting}
\lessonslearned{
...
% TODO L04 MAINTENANCE

\ifuniversity{tubs}{\date{November 11, 2025}}
...
\begin{frame}{\insertsubtitle}
	...
	\uncover<2->{\hprojectcartoon{18}{how patches were applied\\~\\\textbf{maintenance}}} % se04 maintenance
\end{frame}

\section{Software Maintenance}
\input{content/04a-maintenance}
\lessonslearned{
...
\lessonslearned{
	...
	\item Next: How to develop and test frequent versions?
}{
...
\input{content/04c-configurationmanagement}
\lessonslearned{
