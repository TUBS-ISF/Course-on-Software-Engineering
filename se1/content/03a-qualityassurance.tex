...
\begin{frame}[label=productquality]{\insertsubsection\ \mytitlesource{\isoiectfzoz}}
	...
	\begin{tikzpicture}
		...
		[clockwise from=0]
		child[concept color=orange!20!background,visible on={<5->},level distance=33mm] { node {Maintainability} 
			[clockwise from=30]
		...
		child[concept color=red!20!background,visible on={<4->}] { node {Performance Efficiency ...} }
		child[concept color=blue!20!background,visible on={<4->}] { node {Compatibility ...} }
		child[concept color=green!20!background,visible on={<4->}] { node {Usability ...} }
		child[concept color=red!20!background,visible on={<3->},level distance=28mm] { node {Reliability} 
			[clockwise from=255]
			child { node {Maturity} }
		...
		child[concept color=orange!20!background,visible on={<2->}] { node {Security} 
			[clockwise from=190]
		...
		child[concept color=green!20!background,visible on={<1->}] { node {Functional Suitability} 
			[clockwise from=90]
			child { node {Completeness} }
			child { node {Correctness} }
			child { node {Appropriateness} }
		}
		child[concept color=blue!20!background,visible on={<6->}] { node {Portability} 
			[clockwise from=50]
...
\begin{frame}{\insertsubsection\ \mytitlesource{\isoiectfzoz}}
	\begin{tikzpicture}
		...
		[clockwise from=193]
		child[concept color=blue!20!background,visible on={<1->}] { node {Effectiveness} }
		child[concept color=blue!20!background,visible on={<1->}] { node {Efficiency} }
		child[concept color=green!20!background,visible on={<2->}] { node {Satisfaction} 
			[clockwise from=155]
		...
		child[concept color=red!20!background,visible on={<3->}] { node {Freedom from Risk} 
			[clockwise from=75]
			child { node {Economic Risk Mitigation} }
			child { node {Health and Safety Risk Mitigation} }
			child { node {Environmental Risk Mitigation} }
		}
		child[concept color=orange!20!background,visible on=<4->] { node {Context Coverage} 
			[clockwise from=30]
