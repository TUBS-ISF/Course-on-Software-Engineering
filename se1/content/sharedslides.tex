	...
	\begin{fancycolumns}[b]
		\begin{definition}{\insertsubsection\mysource{\href{https://en.wikipedia.org/wiki/CrowdStrike}{wikipedia.org}, \href{https://www.bbc.com/news/articles/c23k4yyjxp3o}{bbc.com}}}
			\begin{itemize}
				...
				\item about 5,000 (5 \%) flights cancelled
...
% introduced: se1-introduction, se2-introduction?
% reused: se2-dynamic
\newcommand{\slideTherac}{
...
% introduced: se1-introduction
% reused: se2-introduction
\newcommand{\slideSaxonyElection}{
	\begin{fancycolumns}
		...
		\end{definition}
		\nextcolumn
		\centering\picWhite[width=.9\linewidth]{misc/saxony}
	\end{fancycolumns}
}
...
\newcommand{\frameCourseQuestions}{
	...
	\begin{fancycolumns}[columns=3,t]
		\begin{definition}{Part A: SE for \emph{Adapting} Software}
			\begin{itemize}
				...
				\item Architecture: How to design interplay between software parts?
				\item (Lego Scrum: How to develop agile and in teams?)
			\end{itemize}
		\end{definition}
		\nextcolumn
		\begin{definition}{Part B: SE for \emph{Verifying} Software}
			\begin{itemize}
		...
		\end{definition}
		\nextcolumn
		\begin{definition}{Part C: \emph{Modern} SE}
			\begin{itemize}
				\item Open-Source Software: When are we allowed to reuse software?
				\item SE4AI \& AI4SE: What is the interplay between software engineering and artificial intelligence?
