...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{Schichtenarchitektur}}
	...
	\begin{fancycolumns}[animation=none]
		...
		\end{definition}
		\nextcolumn
		\posthandout{\picWhite[page=24,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/architecture}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{2-Schichten-Architektur}}
	\begin{fancycolumns}[animation=none]
		...
		\end{example}
		\nextcolumn
		\posthandout{\picWhite[page=25,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/architecture}}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{\insertsubsection\ \normalsize\deutsch{3-Schichten-Architektur}}
	\begin{fancycolumns}[animation=none]
		...
		\end{example}
		\nextcolumn
		\posthandout{\picWhite[page=26,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/architecture}}
	\end{fancycolumns}
\end{frame}
