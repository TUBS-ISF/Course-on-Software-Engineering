...
\begin{frame}[label=statemachineslide]{\insertsubsection}
	\begin{fancycolumns}
		...
		\end{note}
		\nextcolumn
		\posthandout{\pic[page=28,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/modeling}}
...
\end{frame}
	...
	\begin{frame}[t]{Example of a State Machine Diagram}
		\posthandout{\pic[page=29,width=\linewidth,trim=0 20 0 40,clip]{printedslides/2021wt/modeling}}
%		\posthandout{
%			\begin{tikzpicture}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}
		...
		\end{note}
		\nextcolumn
		\posthandout{\pic[page=30,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/modeling}}
%		\posthandout{
%			\begin{tikzpicture}
