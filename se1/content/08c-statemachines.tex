...
\begin{frame}[label=statemachineslide]{\insertsubsection}
	\begin{fancycolumns}
		...
		\end{note}
		\nextcolumn
		\posthandout{\picWhite[page=28,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/modeling}}
		%\posthandout{\pic[page=8,width=\linewidth,trim=460 200 40 80,clip]{modeling/09-modeling_drawings}}
	\end{fancycolumns}
\end{frame}

	\begin{frame}[t]{Example of a State Machine Diagram}
		\posthandout{\picWhite[page=29,width=\linewidth,trim=0 20 0 40,clip]{printedslides/2021wt/modeling}}
%		\posthandout{
%			\begin{tikzpicture}
...
\begin{frame}{\insertsubsection}
	\begin{fancycolumns}
		...
		\end{note}
		\nextcolumn
		\posthandout{\picWhite[page=30,width=\linewidth,trim=225 20 25 40,clip]{printedslides/2021wt/modeling}}
%		\posthandout{
%			\begin{tikzpicture}
