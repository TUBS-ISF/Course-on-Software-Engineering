...
\input{content/07c-documentation}
\lessonslearned{
...
\input{content/08b-activitydiagrams}
\lessonslearned{
...
\input{content/09a-architecture}
\lessonslearned{
...
\input{content/09b-componentdiagrams}
\lessonslearned{
...
\lessonslearned{
	\item[] Common architectural patterns: layered architecture, client-server, 3-tier, peer-to-peer, pipe-and-filter
...
\input{content/10b-classdiagrams}
\lessonslearned{
...
\input{content/10c-designpatterns}
\lessonslearned{
...
\lessonslearned{
	...
	\begin{enumerate}
		\item Form groups of 2--3 students
		\item Find three examples for software systems for which you would recommend any of the following licenses: MIT, GPL, LGPL
		\item What are reasons for the license over the other two licenses?
	\end{enumerate}
}

\section{Lecture Summary}
\input{content/11c-summary}
\lessonslearned{
	\item How to avoid / manage / structure software development?
	\item What software is required?
	\item How to model / design / implement / test / maintain software?
	\item Next: guest lecture, SEP topic presentation, ISF thesis + project presentation
}{
