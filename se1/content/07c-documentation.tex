...
\begin{frame}[label=usecaseslide]{\insertsubsection\ \normalsize(since 1993)}
	\begin{fancycolumns}[animation=none]
		...
		\posthandout{\picWhite[page=50,width=\linewidth,trim=225 20 15 40,clip]{printedslides/2021wt/requirements}}
	\end{fancycolumns}
\end{frame}

\begin{frame}{Example}
	\posthandout{\centering\picWhite[page=51,width=.9\linewidth,trim=25 20 25 0,clip]{printedslides/2021wt/requirements}}
\end{frame}
...
\begin{frame}[label=includeandextendslide]{\insertsubsection}
	\begin{fancycolumns}[animation=none]
		...
		\end{definition}
		\nextcolumn
		\posthandout{\picWhite[page=53,width=\linewidth,trim=225 20 15 50,clip]{printedslides/2021wt/requirements}}
