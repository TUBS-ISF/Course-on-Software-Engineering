...
%Git Dags
\usepackage{../se1/template/gitdags}
\usepackage{colortbl}
\usepackage{makecell}

% commented out to as only used for Florian's lecture which needs to be revised anyway
...
\renewcommand{\posthandout}[1]{#1} % comment out to hide diagrams drawn in the lectures
...
\makeatletter
\fancy@DeclareBox{motivation}{yellow}
\makeatother
